  ...
  const handleSingleSave = async (tempId: string) => {
    ...
    try {
      ...
      const recordData = {
        ...
        記錄時間: record.記錄時間,
        記錄類型: record.記錄類型,
        血壓收縮壓: record.血壓收縮壓 || undefined,
        血壓舒張壓: record.血壓舒張壓 || undefined,
        脈搏: record.脈搏 || undefined,
        體溫: vitals.體溫 || undefined,
        血含氧量: vitals.血含氧量 || undefined,
        呼吸頻率: vitals.呼吸頻率 || undefined,
        血糖值: record.血糖值 || undefined,
        體重: record.體重 || undefined,
        備註: record.備註 || undefined,
