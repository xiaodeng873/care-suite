...
const RestraintAssessmentModal: React.FC<RestraintAssessmentModalProps> = ({ assessment, onClose, onUpdate, renewFrom }) => {
  ...
  const initialUsageRecord = assessment?.usage_record || {
    ...
    end_date: '',
    doctor: renewFrom?.usage_record?.doctor || '',
    reasons: (renewFrom?.usage_record?.reasons ?? {}) as Record<string, boolean | string>,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <DateInput
                ...
                className="form-input" onChange={(value) => setFormData((prev) => ({ ...prev, doctor_signature_date: value }))} />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <DateInput
                    ...
                    className="form-input" onChange={(value) => setFormData((prev) => ({ ...prev, usage_record: { ...prev.usage_record, end_date: value } }))} />
