...
import {
  ...
  type CaseConferenceProfessional } from
          ...
          <>
            ...
            <div className="space-y-6">
                ...
                <div className="col-span-2 p-4 bg-blue-50 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-amber-600 flex items-center">
                      ...
                      className={`form-input ${currentPlan?.status === '待生效' ? 'bg-gray-50 cursor-not-allowed' : ''}`} onChange={(value) => setFormData((prev) => ({ ...prev, plan_date: value }))} />
                      ...
                      <div>
                        ...
                        <DateInput value={currentPlan?.review_due_date || calculatedReviewDueDate} className="form-input bg-gray-50 cursor-not-allowed" onChange={() => {}} />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="border rounded-lg p-4 bg-blue-50">
                    ...
                    <div key={pa.category} className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                          ...
                          className="form-input text-sm w-full" onChange={(value) => handleProfessionalAssessmentChange(pa.category, 'assessment_date', value)} />
            ...
            <div className="space-y-6">
              ...
              <>
                    ...
                    className="form-input max-w-xs" onChange={(value) => setReviewDate(value)} />
            ...
            <div className="space-y-6">
              ...
              <>
                    ...
                    max={currentPlan?.review_due_date || calculatedReviewDueDate || formData.plan_date}
                    className="form-input w-full max-w-xs" onChange={(value) => setCaseConference((prev) => ({ ...prev, conference_date: value }))} />
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        className="form-input w-full" onChange={(value) => setCaseConference((prev) => ({ ...prev, family_contact_date: value }))} />
