  ...
  const handleExportSelected = () => {
    ...
    const exportData = selectedGuidances.map(guidance => {
      ...
      return {
        ...
        凝固粉分量: guidance.thickener_amount ? `${guidance.thickener_amount}${guidance.thickener_formula === '清透配方' ? `（清透配方）` : ''}` : '',
                        ...
                        {guidance.needs_thickener ? (
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-blue-600 font-medium">
                              {guidance.thickener_amount || '是'}{guidance.thickener_formula === '清透配方' ? `（清透配方）` : ''}
                            </span>
                          </div>
                        ) : (
