...
const PrintForms: React.FC = () => {
  ...
  const getAdmissionTypeBadgeClass = (type: string) => {
    switch (type) {
      ...
      case '院舍券級別0': return 'bg-green-100 text-green-800';
      case '院舍券級別1-7': return 'bg-green-100 text-green-800';
  ...
  if (loading) {
    return <LoadingScreen pageName="列印表格" />;
  }
  return (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="院舍券級別0">院舍券級別0</option>
                      <option value="院舍券級別1-7">院舍券級別1-7</option>
