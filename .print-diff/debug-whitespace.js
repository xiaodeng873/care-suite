...
(async () => {
  ...
  const variants = {
    '有空白+font-size:0': `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>html,body{margin:0;padding:0;font-size:0;}@page{size:A4 portrait;margin:0;}</style><style>${styles}</style></head><body>\n<div class="print-doc-0-0" style="padding: 5mm 6.35mm; box-sizing: border-box;">${body}</div>\n</body></html>`,
    '無空白': `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>html,body{margin:0;padding:0;}@page{size:A4 portrait;margin:0;}</style><style>${styles}</style></head><body><div class="print-doc-0-0" style="padding: 5mm 6.35mm; box-sizing: border-box;">${body}</div></body></html>`,
    '無包wrapper': `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>html,body{margin:0;padding:0;}@page{size:A4 portrait;margin:0;}</style><style>${styles}</style></head><body>${body}</body></html>`,
  };
