...
(async () => {
  ...
  const variants = {
    'padding 5mm 0': 'padding: 5mm 0; box-sizing: border-box;',
    'padding 0 6.35mm': 'padding: 0 6.35mm; box-sizing: border-box;',
    'padding-top 5mm': 'padding-top: 5mm; box-sizing: border-box;',
    'padding-bottom 5mm': 'padding-bottom: 5mm; box-sizing: border-box;',
    'padding 4mm': 'padding: 4mm; box-sizing: border-box;',
    'border-top 5mm': 'border-top: 5mm solid transparent; box-sizing: border-box;',
  };

  const browser = await chromium.launch({ executablePath: CHROME });
  for (const [name, wrapStyle] of Object.entries(variants)) {
    const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><style>html,body{margin:0;padding:0;}@page{size:A4 portrait;margin:0;}</style><style>${styles}</style></head><body><div class="print-doc-0-0" style="${wrapStyle}">${body}</div></body></html>`;
