...
(async () => {
  ...
  const variants = {
    'wrapper+padding, 刪除.page分頁規則': styles
      .replace(/page-break-after:\s*always;\s*/g, '')
      .replace(/break-after:\s*page;\s*/g, '')
      .replace(/\.page:last-child\s*\{[^}]*\}/g, ''),
    'wrapper+padding, 原樣': styles,
  };
