...
(async () => {
  ...
  // 模擬 printGroupedHtml 新做法：兩份文件、兩種 margin、兩個具名 @page
...
<style>
  ...
  @page pg-0-0 { size: A4 portrait; margin: 5mm 0.25in; }
  @page pg-0-1 { size: A4 portrait; margin: 5mm 0.2in; }
</style>
<style>${styles}</style>
</head>
<body>
<div class="print-doc-0-0" style="page: pg-0-0;">${body}</div>
<div class="print-doc-0-1" style="page: pg-0-1;">${body}</div>
</body>
</html>`;
  ...
  console.log('兩份不同margin文件 pdfPages=', pdfDoc.getPageCount(), '(期望 2)');
  await browser.close();
