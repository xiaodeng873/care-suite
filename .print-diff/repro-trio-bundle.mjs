...
for (const [name, p] of [
  ...
  ['hygiene', hyg.generateHygieneRecordFormForDateRange(dummyPatient, [], '2026-07-01', '2026-07-31', '善頤（福群）護老院')],
  ['restraint', rest.generateRestraintUsageRecordHtml([], dummyPatient, '善頤（福群）護老院')],
]) {
...
fs.writeFileSync(path.join(__dirname, 'repro-trio.pdf'), pdfBuf);
await browser.close();
