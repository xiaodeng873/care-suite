// 處方服藥日排程判斷（edge function 專用）
// ─────────────────────────────────────────────────────────────
// ⚠️ 本檔案邏輯必須同 apps/web/src/utils/prescriptionSchedule.ts 保持同步。
//    前端改咗服藥日語意，呢度一定要跟住改，否則生成/清理嘅記錄會同前端顯示唔一致。
//
 ...
 * 涵蓋：每日 / 每N日 / 每N星期 / 每N月 / 逢星期 / 單雙日 / 每小時。
 */
